...
For unit $i=1$ in time $t$, the potential response *without* the intervention is defined as $Y^{N}_{it}$, while for the unit *with* by the intervention $i=1$ at time $t>T_0$, the potential response is defined as $Y^{I}_{1t}$. Thus the effect of the intervention at $t>T_0$ is given by
