...
\begin{document}
 ...
 \end{enumerate}
 \[(\hat{\beta},\hat{F},\hat{\lambda})=\arg\min_{\tilde{\beta},\tilde{F},\tilde{\Lambda}}\sum_{i\in C}(Y_{i}-X_{i} \tilde{\beta}-\tilde{F}\tilde{\lambda_{i}})'(Y_{i}-X_{i}\tilde{\beta}-\tilde{F}\tilde{\lambda_{i}})\]
 2. Estimate factor loadings for the treated unit by minimizng MSPE of the predicted treated outcome in the pre-treatment period:
