...
\begin{document}
 ...
 \hypertarget{estimating-measurement-error-in-indian-gdp-using-synthetic-control}{%
 \chapter{Estimating measurement error in Indian GDP using synthetic control}\label{estimating-measurement-error-in-indian-gdp-using-synthetic-control}}
 ...
 \hypertarget{econometric-methodology}{%
