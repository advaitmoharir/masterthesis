...
## National Accounting: A Brief History
...
```{r nag1, echo=FALSE, fig.align="center",out.width="100%", fig.cap="Disaggregated GDP growth rates by sector (2012-13)"}
include_graphics("figure/nagaraj1.jpeg")
```

```{r nag2, echo=FALSE, fig.align="center",out.width="100%", fig.cap="Disaggregated GDP growth rates by sector (2013-14)"}
