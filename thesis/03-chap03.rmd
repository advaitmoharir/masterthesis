...
```{r indgsyn, echo=FALSE, fig.align="center", out.width="100%",fig.asp=0.62, fig.cap="Evolution of Log GDP for India and Synthetic India (GSCM)"}

include_graphics("figure/indiagsynth.jpeg")
```

```{r indgsyngap, echo=FALSE, fig.align="center", fig.asp=0.62,out.width="100%", fig.cap="Evolution of Log GDP for India and Synthetic India (GSCM)"}
